...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App */ \"./App.ts\");\n/* harmony import */ var _src_core_Store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/core/Store */ \"./src/core/Store.ts\");\n/* harmony import */ var _src_core_nDom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/core/nDom */ \"./src/core/nDom.ts\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.css */ \"./style.css\");\n\n\n\n\n(() => {\n    const root = document.getElementById(\"root\");\n    if (!root) {\n        throw new Error(\"root element not found\");\n    }\n    function stateToRenderingTree(store) {\n        const AppRenderingTree = (0,_App__WEBPACK_IMPORTED_MODULE_0__.App)(store);\n        return AppRenderingTree;\n    }\n    function updateStateOnAction(store, action) {\n        switch (action.type) {\n            case \"DateIndicate\":\n                store.state.date = new Date();\n                break;\n        }\n    }\n    const state = {\n        date: new Date(),\n    };\n    (0,_src_core_nDom__WEBPACK_IMPORTED_MODULE_2__.setUp)(root, new _src_core_Store__WEBPACK_IMPORTED_MODULE_1__.Store(state), stateToRenderingTree, updateStateOnAction);\n})();\n\n\n//# sourceURL=webpack://webpack/./index.ts?");

/***/ }),

/***/ "./src/components/DateIndicator.ts":
/*!*****************************************!*\
  !*** ./src/components/DateIndicator.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   DateIndicator: () => (/* binding */ DateIndicator)\n/* harmony export */ });\n/* harmony import */ var _core_TagHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/TagHelper */ \"./src/core/TagHelper.ts\");\n/* harmony import */ var _core_invoke__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/invoke */ \"./src/core/invoke.ts\");\n/* harmony import */ var _core_nDom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../core/nDom */ \"./src/core/nDom.ts\");\n\n\n\nconst DateIndicator = ({ date }) => {\n    const options = {\n        year: \"numeric\",\n        month: \"2-digit\",\n        day: \"2-digit\",\n        weekday: \"long\",\n        second: \"2-digit\",\n    };\n    const { p } = _core_TagHelper__WEBPACK_IMPORTED_MODULE_0__.TagHelper;\n    return (0,_core_nDom__WEBPACK_IMPORTED_MODULE_2__.use)(() => {\n        const intervalId = window.setInterval(() => {\n            (0,_core_invoke__WEBPACK_IMPORTED_MODULE_1__.invoke)({\n                type: \"DateIndicate\",\n            });\n        }, 1000);\n        return () => {\n            window.clearInterval(intervalId);\n        };\n    }, []).render(p({ class: \"date\" }, [date.toLocaleDateString(\"ko-KR\", options)]));\n};\n\n\n//# sourceURL=webpack://webpack/./src/components/DateIndicator.ts?");
...
/***/ "./src/components/Rolling.ts":
/*!***********************************!*\
  !*** ./src/components/Rolling.ts ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Rolling: () => (/* binding */ Rolling)\n/* harmony export */ });\n/* harmony import */ var _core_TagHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core/TagHelper */ \"./src/core/TagHelper.ts\");\n\nconst Rolling = () => {\n    const { ul, li, a } = _core_TagHelper__WEBPACK_IMPORTED_MODULE_0__.TagHelper;\n    return ul({ class: \"rolling\" }, [\n        li([\n            a({ class: \"outlet\", href: \"\" }, [\"연합뉴스\"]),\n            a({ class: \"article\", href: \"\" }, [\n                \"[1보] 김기현·안철수·천하람·황교안, 與전대 본경선 진출\",\n            ]),\n        ]),\n    ]);\n};\n\n\n//# sourceURL=webpack://webpack/./src/components/Rolling.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   TagHelper: () => (/* binding */ TagHelper),\n/* harmony export */   generateTagHelper: () => (/* binding */ generateTagHelper)\n/* harmony export */ });\n/* harmony import */ var _utils_getHtmlTags__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/getHtmlTags */ \"./src/utils/getHtmlTags.ts\");\n/* harmony import */ var _nDom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nDom */ \"./src/core/nDom.ts\");\n\n\nfunction generateTagHelper() {\n    const htmlTags = (0,_utils_getHtmlTags__WEBPACK_IMPORTED_MODULE_0__.getHtmlTags)();\n    const helper = {};\n    htmlTags.forEach((tag) => {\n        helper[tag] = (first, second) => {\n            if (!first) {\n                return (0,_nDom__WEBPACK_IMPORTED_MODULE_1__.$)(tag);\n            }\n            else if (Array.isArray(first)) {\n                return (0,_nDom__WEBPACK_IMPORTED_MODULE_1__.$)(tag, first);\n            }\n            else if (second) {\n                return (0,_nDom__WEBPACK_IMPORTED_MODULE_1__.$)(tag, first, second);\n            }\n            else {\n                return (0,_nDom__WEBPACK_IMPORTED_MODULE_1__.$)(tag, first);\n            }\n        };\n    });\n    return helper;\n}\nconst TagHelper = generateTagHelper();\n\n\n//# sourceURL=webpack://webpack/./src/core/TagHelper.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   invoke: () => (/* binding */ invoke)\n/* harmony export */ });\n/* harmony import */ var _nDom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./nDom */ \"./src/core/nDom.ts\");\n\nfunction invoke(action) {\n    (0,_nDom__WEBPACK_IMPORTED_MODULE_0__.onAction)(action);\n}\n\n\n//# sourceURL=webpack://webpack/./src/core/invoke.ts?");
